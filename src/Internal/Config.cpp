...
namespace Internal::Config
{
	...
	static const std::string FILE_PATH_TOML = fmt::format("{}/{}.toml"sv, PLUGINS_PATH, Plugin::NAME);
	static const std::string CUSTOM_FILE_PATH_TOML = fmt::format("{}/{}_Custom.toml"sv, PLUGINS_PATH, Plugin::NAME);
